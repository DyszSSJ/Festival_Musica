...
function navegacionFija() {
  const e = document.querySelector(".header"),
    n = document.querySelector(".sobre-festival"),
    t = document.querySelector("body");
  window.addEventListener("scroll", function () {
    n.getBoundingClientRect().bottom < 0
      ? (e.classList.add("fijo"), t.classList.add("body-scroll"))
      : (e.classList.remove("fijo"), t.classList.remove("body-scroll"));
  });
}
function scrollNav() {
  document.querySelectorAll(".navegacion-principal a").forEach((e) => {
    e.addEventListener("click", function (e) {
      e.preventDefault();
      const n = e.target.attributes.href.value;
...
function mostrarImagen(e) {
  ...
  n.innerHTML = `\n        <source srcset="build/img/grande/${e}.webp" type="image/webp" />\n\n        <img\n            loading="lazy"\n            width="200"\n            height="300"\n            src="src/img/grande/${e}.jpg"\n            alt="Imagen Galeria"\n        />\n    \n    `;
  const t = document.createElement("DIV");
  t.appendChild(n),
    t.classList.add("overlay"),
    (t.onclick = function () {
      document.querySelector("body").classList.remove("fijar-body"), t.remove();
    });
  ...
  c.appendChild(t), c.classList.add("fijar-body");
}
